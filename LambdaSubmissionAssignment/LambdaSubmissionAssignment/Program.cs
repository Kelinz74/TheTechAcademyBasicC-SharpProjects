...
namespace LambdaSubmissionAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            employees.Add(new Employee(2, "Fread", "Smith"));
            employees.Add(new Employee(3, "Jeremiah", "Smith"));
            employees.Add(new Employee(4, "Jasmine", "Smith"));
            employees.Add(new Employee(5, "Desirea", "Smith"));
            employees.Add(new Employee(6, "Chloe", "Smith"));
            employees.Add(new Employee(7, "Grace", "Smith"));
