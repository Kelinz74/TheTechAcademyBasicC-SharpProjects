    ...
    public class InsureeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,EmailAddress,DateOfBirth,CarYear,CarMake,CarModel,DUI,SpeedingTickets,CoverageType,Quote")] Insuree insuree)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //if the car is older more then 22 years old set by the standard of this project, if it was to be used in the future. 
                //older then 2000
                if (DateTime.Now.Year - insuree.CarYear >= 22)
                {
                    insuree.Quote += 25;
                }
                //if the car was younger then 6 years old set by the standard of this project, if it was used in the future. 2015 to present
